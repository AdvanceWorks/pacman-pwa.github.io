...
function initFruits() {
    ...
    levelCanvas.setAttribute('width', '150');
    ...
    var spacer = 37;
    drawFruit(ctx, 'cherry', x - ( i * spacer), y, 27);
    i ++;
    
    if (LEVEL > 1) {
        drawFruit(ctx, 'strawberry', x - ( i * spacer), y, 27);
        i ++;
    }
    if (LEVEL > 2) {
        drawFruit(ctx, 'orange', x - ( i * spacer), y, 27);
        i ++;
    }
    if (LEVEL > 3) {
        drawFruit(ctx, 'orange', x - ( i * spacer), y, 27);
    ...
    if (LEVEL > 4) {
        drawFruit(ctx, 'apple', x - ( i * spacer), y, 27);
        i ++;
    }
    if (LEVEL > 5) {
        drawFruit(ctx, 'apple', x - ( i * spacer), y, 27);
    ...
    if (LEVEL > 6) {
        drawFruit(ctx, 'melon', x - ( i * spacer), y, 27);
        i ++;
    }
    if (LEVEL > 7) {
        drawFruit(ctx, 'melon', x - ( i * spacer), y, 27);
    ...
    if (LEVEL > 8) {
        drawFruit(ctx, 'galboss', x - ( i * spacer), y, 27);
        i ++;
    }
    if (LEVEL > 9) {
        drawFruit(ctx, 'galboss', x - ( i * spacer), y, 27);
    ...
    if (LEVEL > 10) {
        drawFruit(ctx, 'bell', x - ( i * spacer), y, 27);
        i ++;
    }
    if (LEVEL > 11) {
        drawFruit(ctx, 'bell', x - ( i * spacer), y, 27);
    ...
    if (LEVEL > 12) {
        drawFruit(ctx, 'key', x - ( i * spacer), y, 27);
        i ++;
    }
}

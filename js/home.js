...
function initHome() {
    ...
    var width = screen.width/14;
    var height = screen.height/8;
    canvas.setAttribute('width', width < 80 ? 80 : width);
    canvas.setAttribute('height', height < 70 ? 70 : height);
    ...
    ctx.beginPath();
    ctx.arc(x, y, 35, (0.35 - (3 * 0.05)) * Math.PI, (1.65 + (3 * 0.05)) * Math.PI, false);
    ctx.lineTo(x - 10, y);
    ctx.fill();
    ctx.closePath();
...
function startPresentation() {   
    $('#presentation td > *:not(span:first-child)').hide();
...
function drawGhostsTrailer() {
    ...
    drawHelperGhost(ctx, 'BLINKY', GHOST_BLINKY_TRAILER_POSITION_X, GHOST_BLINKY_TRAILER_POSITION_Y, GHOST_BLINKY_TRAILER_DIRECTION, GHOST_BLINKY_TRAILER_BODY_STATE, GHOST_BLINKY_TRAILER_STATE, 0);
    ...
    drawHelperGhost(ctx, 'PINKY', GHOST_PINKY_TRAILER_POSITION_X, GHOST_PINKY_TRAILER_POSITION_Y, GHOST_PINKY_TRAILER_DIRECTION, GHOST_PINKY_TRAILER_BODY_STATE, GHOST_PINKY_TRAILER_STATE, 0);
    ...
    drawHelperGhost(ctx, 'INKY', GHOST_INKY_TRAILER_POSITION_X, GHOST_INKY_TRAILER_POSITION_Y, GHOST_INKY_TRAILER_DIRECTION, GHOST_INKY_TRAILER_BODY_STATE, GHOST_INKY_TRAILER_STATE, 0);
    ...
    drawHelperGhost(ctx, 'CLYDE', GHOST_CLYDE_TRAILER_POSITION_X, GHOST_CLYDE_TRAILER_POSITION_Y, GHOST_CLYDE_TRAILER_DIRECTION, GHOST_CLYDE_TRAILER_BODY_STATE, GHOST_CLYDE_TRAILER_STATE, 0);
}
...
function getPacmanTrailerCanvasContext() {
    return PACMAN_TRAILER_CANVAS_CONTEXT;
}
function drawPacmanTrailer() {

    var ctx = getPacmanTrailerCanvasContext();

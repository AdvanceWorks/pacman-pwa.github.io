...
{
    var canvasOffset = $('#canvas-board').offset();
    var canvasHeight = $('#canvas-board').height();
    var canvasWidth = $('#canvas-board').width();
    $('#message').css('top', canvasOffset.top + canvasHeight/2 + canvasHeight *0.04);
    $('#message').css('left', canvasOffset.left + canvasWidth/2 - $('#message').width()/2);
}
...
function setOtherElementsPosition()
{
    var canvasOffset = $('#canvas-board').offset();
    var canvasHeight = $('#canvas-board').height();
    var canvasWidth = $('#canvas-board').width();

    $('#canvas-lifes').css('top', canvasOffset.top + canvasHeight);
    $('#canvas-lifes').css('left', canvasOffset.left);
    $('#settings').css('top', canvasOffset.top + canvasHeight);
    $('#settings').css('left', canvasOffset.left + canvasWidth/2 - $('#settings').width()/2);

    $('#canvas-level-fruits').css('top', canvasOffset.top + canvasHeight);
    $('#canvas-level-fruits').css('left', canvasOffset.left + canvasWidth - $('#canvas-level-fruits').width());
    setMessagePosition();
}
